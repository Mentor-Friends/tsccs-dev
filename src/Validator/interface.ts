...
export interface FormFieldData {
    name: string|null; // name of the form element (e.g: the_name, the_email )
    value: string|null; // value of the field (e.g., email address, password, etc.)
    type?: string|null, // type of input field (e.g. text, email, number, file)
    dataType?: string | null; //  Data type of the field (e.g., "text", "number", "email", "text-only" etc.)
