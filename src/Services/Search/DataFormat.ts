...
import GetTheConcept from "../GetTheConcept";
   ...
   * @returns 
   */
    export async function FormatFunctionDataForClean(connections:Connection[], compositionData: any[], reverse: number [] = []){
 ...
 * @returns 
 */
export async function FormatFromConnectionsAlteredArrayExternalClean(connections:Connection[], compositionData: any[],  mainComposition: number[], reverse: number [] = [], CountDictionary: any[]){
                      ...
                      if(isComp){
                        ...
                        if(myData){
                            testData[mytype] = {
                              "data": myData[mytype],
                              "id": ofTheConcept.id,
                              "created_on": toTheConcept.entryTimeStamp
                            };
                        }
                        ...
                        if(Array.isArray(newData[key])){
                              if(isComp){
                                  newData[key].push(myData[reverseCharater]);
                            ...
                            if(Array.isArray(newData[key][reverseCharater])){
                                newData[key][reverseCharater].push(testData);
                            }
                            else{
                            ...
                            if(reverseCharater.includes("_s_")){
                                ...
                                newData[key][reverseCharater].push(testData[mytype]);
                            }
                            else{
                                newData[key][reverseCharater] = testData;
                            }
                  ...
                  try{
                    ...
                    if(myData){
                        ...
                        testData[mytype] = {
                          "data": myData[mytype],
                          "id": toTheConcept.id,
                          "created_on": ofTheConcept.entryTimeStamp
                        };
                          if(Array.isArray(newData[key])){
                              if(isComp){
