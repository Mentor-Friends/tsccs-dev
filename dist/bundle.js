...
exports.BASE_URL = "https://alpha.freeschema.com";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.selectConceptObject = void 0;
const ConceptData_1 = __webpack_require__(/*! ../DataStructures/ConceptData */ "./src/DataStructures/ConceptData.ts");
function selectConceptObject(mouse_x_coordinate, mouse_y_coordinate) {
    var conceptArray = ConceptData_1.ConceptsData.conceptsArray;
    var offset = 50;
...
exports.selectConceptObject = selectConceptObject;
        ...
        for (const key in json) {
            if (typeof json[key] != 'string') {
                if (ofTheConceptId == null && ofTheConceptUserId == null) {
                    ...
                    (0, CreateTheConnection_1.default)(ofThe, ofTheUser, concept.id, concept.userId, localMainKey, localSessionId, concept.userId);
                    CreateTheComposition(json[key], concept.id, concept.userId, localMainKey, userId, accessId, sessionInformationId);
                }
            }
            else {
...
const SplitStrings_1 = __importDefault(__webpack_require__(/*! ./SplitStrings */ "./src/Services/SplitStrings.ts"));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (existingConcept) {
            if (existingConcept.id == 0 || existingConcept.userId == 0) {
                var splittedStringArray = (0, SplitStrings_1.default)(typeString);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const ConceptEvents_1 = __webpack_require__(/*! ./Drawing/ConceptEvents */ "./src/Drawing/ConceptEvents.ts");
const GetComposition_1 = __webpack_require__(/*! ./Services/GetComposition */ "./src/Services/GetComposition.ts");
const GetCompositionList_1 = __webpack_require__(/*! ./Services/GetCompositionList */ "./src/Services/GetCompositionList.ts");
const CreateTheComposition_1 = __importDefault(__webpack_require__(/*! ./Services/CreateTheComposition */ "./src/Services/CreateTheComposition.ts"));
const SyncData_1 = __webpack_require__(/*! ./DataStructures/SyncData */ "./src/DataStructures/SyncData.ts");
const ConceptData_1 = __webpack_require__(/*! ./DataStructures/ConceptData */ "./src/DataStructures/ConceptData.ts");
const form = document.querySelector('#myForm');
//const form2 = document.querySelector('#userForm') as HTMLFormElement;
const form3 = document.querySelector('#compositionForm');
...
setInterval(function () {
    SyncData_1.SyncData.SyncDataOnline();
    console.log(ConceptData_1.ConceptsData.conceptsArray);
}, 5000);
form.addEventListener('submit', (event) => {
    event.preventDefault();
    const conceptIdElement = document.querySelector('#conceptid');
    const conceptId = conceptIdElement.value;
    (0, GetComposition_1.GetComposition)(Number(conceptId)).then(output => {
        const jsonElemnt = document.querySelector('#jsonoutput');
...
getname.addEventListener('submit', (event) => {
    event.preventDefault();
    const conceptIdElement = document.querySelector('#nameconceptid');
    const conceptId = conceptIdElement.value;
    (0, GetComposition_1.GetComposition)(Number(conceptId)).then(output => {
...
nameForm.addEventListener('submit', (event) => {
    ...
    console.log(json);
    (0, CreateTheComposition_1.default)(json).then((value) => {
...
jsonForm.addEventListener('submit', (event) => {
    event.preventDefault();
    const compositionNameElement = document.querySelector("#jsondata");
    ...
    (0, CreateTheComposition_1.default)(jon).then((value) => {
        const outputid = document.querySelector('#outputid');
        var concept = value;
        outputid.innerHTML = concept.id.toString();
        console.log('this is the test for final');
...
form3.addEventListener('submit', (event) => {
    event.preventDefault();
    const compositionNameElement = document.querySelector("#composition_name");
    const compositionName = compositionNameElement.value;
    (0, GetCompositionList_1.GetCompositionList)(compositionName).then(output => {
        const jsonElemnt = document.querySelector('#jsonoutput');
        var json = JSON.stringify(output);
        console.log(json);
...
window.onmousedown = (ev) => {
    ...
    var selected_concept_object = (0, ConceptEvents_1.selectConceptObject)(mouse_x_coordinate, mouse_y_coordinate);
...
/******/ })()
;
//# sourceMappingURL=data:application/json;charset=utf-8;base64,